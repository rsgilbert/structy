...
const { mergeSort } = require('../../src/mixed-recall/merge-sort');

describe('mergeSort', () => {
    test('test_00', () => {
        const numbers = [10, 4, 42, 5, 8, 100, 5, 6, 12, 40];
        expect(mergeSort(numbers)).toEqual([4, 5, 5, 6, 8, 10, 12, 40, 42, 100]);
        // -> [ 4, 5, 5, 6, 8, 10, 12, 40, 42, 100 ] 
    })
    test('test_01', () => {
        const numbers = [7, -30, -4, -1, 12, 0, 20];
        expect(mergeSort(numbers)).toEqual([-30, -4, -1, 0, 7, 12, 20]);
        // -> [ -30, -4, -1, 0, 7, 12, 20 ] 
    })
    test('test_02', () => {
        const numbers = [8, 7, 6, 5, 4, 3, 2, 1, 0];
        expect(mergeSort(numbers)).toEqual([0, 1, 2, 3, 4, 5, 6, 7, 8]);
        // -> [ 0, 1, 2, 3, 4, 5, 6, 7, 8 ] 
    })
    test('test_03', () => {
        const numbers = [
    ...
    test('test_04', () => {
        ...
        expect(mergeSort(numbers)).toEqual(new Array(95000).fill(7));
        // -> [7, 7, 7, 7, 7, ...]
    })
    test('test_05', () => {
        const numbers = new Array(120000).fill(7);
        expect(mergeSort(numbers)).toEqual(new Array(120000).fill(7));
        // -> [7, 7, 7, 7, 7, ...]
    })
})
